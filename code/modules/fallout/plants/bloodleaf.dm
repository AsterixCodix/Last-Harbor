/obj/item/seeds/poppy/bloodleaf
	...
	icon_harvest = "broc-harvest"//temp
	icon_grow = "broc-grow"//temp
	icon_dead = "broc-dead"//temp
...
/obj/item/reagent_containers/food/snacks/grown/bloodleaf
	...
	juice_results = list(/datum/reagent/consumable/tea/broctea = 0)//temp
	distill_reagent = /datum/reagent/consumable/ethanol/brocbrew//temp
